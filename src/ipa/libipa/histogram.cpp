 ...
 * \param[in] double the number of bins
 ...
 * \param[in] double the desired point (0 <= q <= 1)
 * \param[in] int low limit (optionnal if -1)
 * \param[in] int high limit (optionnal if -1)
 ...
 * \param[in] double low Quantile
 * \param[in] double high Quantile
